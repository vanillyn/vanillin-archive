...
const gifs = [
  "https://cdn.upload.systems/uploads/riGJGwQE.gif",
  "https://cdn.upload.systems/uploads/GjJs4hBo.gif",
  "https://cdn.upload.systems/uploads/EPJrCyRC.gif",
  "https://vanillyn.shx.is/5M_MPNdLZ.gif",
  "https://vanillyn.shx.is/5M_MPNdLZ.gif",
  "https://vanillyn.shx.is/5M_MNVOpc.gif",
  "https://vanillyn.shx.is/5M_MMAWzW.gif",
  "https://vanillyn.shx.is/5M_MKJwd9.gif",
];
  ...
  async execute(interaction) {
    ...
    if (interaction.user == patd) {
      await interaction.reply({
        content: "You can't headpat yourself, but, I'll headpat you!",
        ephemeral: true,
      });

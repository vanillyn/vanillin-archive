...
const { SlashCommandBuilder, EmbedBuilder } = require("discord.js");
const gifs = [
  "https://cdn.upload.systems/uploads/7orUqWpY.gif",
  "https://cdn.upload.systems/uploads/BATSgJzE.gif",
  "https://cdn.upload.systems/uploads/RyxR9Do4.gif",
  "https://cdn.upload.systems/uploads/JZ1ht1Qv.gif",
  "https://vanillyn.shx.is/5M_GzsQpR.gif",
  "https://vanillyn.shx.is/5M_GFRpNX.gif",
  "https://vanillyn.shx.is/5M_GIMWdK.gif",
  "https://cdn.upload.systems/uploads/WdC5z8Ab.gif",
];
const { auth, vanillin } = require("../config.json");
  ...
  async execute(interaction) {
    ...
    if (interaction.user == licked) {
      await interaction.reply({
        content: "Go lick yourself in DMs",
        ephemeral: true,
      });
      await interaction.stop();
    } else {
